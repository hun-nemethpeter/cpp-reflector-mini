...
void test_ast_building()
{
  ...
  static constexpr ast_function abstract_int_funtion_param0(nullptr, &builtin_types::type_int);


  //  int (*)(char, double);
  auto fooFn2() -> int (*)(char, double);
  static constexpr std::initializer_list<const ast_type*> param_seq_values = { &builtin_types::type_char, &builtin_types::type_double };
  static constexpr sequence<const ast_type*> param_seq(param_seq_values);
  ...
  //  int test();
  static constexpr ast_fundecl int_funtion_param0(&id_test, &abstract_int_funtion_param0, nullptr);
