...
namespace ipr {
   namespace impl {
     ...
     struct unified_type_compare
     {
      ...
      /// Changed sizeof and typeid on types to be unified
      impl::Type_sizeof*
      ...
      Unit::Unit()
            : cxx_linkage(get_string("C++")),
              c_linkage(get_string("C")),
      ...
      //-----------------------------
      //--- impl::Unit::get_string --
      //-----------------------------

      const ipr::String&
      Unit::get_string(const char* s)
      {
         return get_string(s,std::strlen(s));
      }

      const ipr::String&
      Unit::get_string(const std::string& s)
      {
      ...
      const ipr::String&
      Unit::get_string(const char* s, int n)
      {
      ...
      //----------------------------------
      //--- impl::Unit::get_cxx_linkage --
      //----------------------------------

      const ipr::Cxx_linkage&
      ...
      //------------------------------
      //--- impl::Unit::get_linkage --
      //------------------------------

      const ipr::Linkage&
      Unit::get_linkage(const char* s)
      {
         return get_linkage(get_string(s));
      }

      const ipr::Linkage&
      Unit::get_linkage(const std::string& s)
      {
         return get_linkage(get_string(s));
      }

      const ipr::Linkage&
      Unit::get_linkage(const ipr::String& lang)
      {
         if (lang == cxx_linkage.rep)
            return cxx_linkage;
         if (lang == c_linkage.rep)
            return c_linkage;
