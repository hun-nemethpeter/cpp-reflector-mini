...
///      Float, Double[, Long_double, Ellipsis
/// are results of the "As_type" type constructor.  Consequently,
/// by default, they should be visited as if they were "As_type".
/// 
void
ipr::Visitor::visit(const Void& t)
{
   visit(as<As_type>(t));
}

void
ipr::Visitor::visit(const Bool& t)
{
   visit(as<As_type>(t));
}

void
ipr::Visitor::visit(const Char& t)
{
   visit(as<As_type>(t));
}

void
ipr::Visitor::visit(const sChar& t)
{
   visit(as<As_type>(t));
}

void
ipr::Visitor::visit(const uChar& t)
{
   visit(as<As_type>(t));
}

void
ipr::Visitor::visit(const Short& t)
{
   visit(as<As_type>(t));
}

void
ipr::Visitor::visit(const uShort& t)
{
   visit(as<As_type>(t));
}
...
void
ipr::Visitor::visit(const Int& t)
{
   visit(as<As_type>(t));
}

void
ipr::Visitor::visit(const uInt& t)
{
   visit(as<As_type>(t));
}

void
ipr::Visitor::visit(const Long& t)
{
   visit(as<As_type>(t));
}

void
ipr::Visitor::visit(const uLong& t)
{
   visit(as<As_type>(t));
}

void
ipr::Visitor::visit(const Long_long& t)
{
   visit(as<As_type>(t));
}

void
ipr::Visitor::visit(const uLong_long& t)
{
   visit(as<As_type>(t));
}

void
ipr::Visitor::visit(const Float& t)
{
   visit(as<As_type>(t));
}

void
ipr::Visitor::visit(const Double& t)
{
   visit(as<As_type>(t));
}

void
ipr::Visitor::visit(const Long_double& t)
{
   visit(as<As_type>(t));
}

void
ipr::Visitor::visit(const Ellipsis& t)
{
   visit(as<As_type>(t));
}
...
///
/// Similarly, the built-in language linkage constants are visited,
/// by default, as ordinary language linkage.
///
void
ipr::Visitor::visit(const Cxx_linkage& l)
{
   visit(as<Linkage>(l));
}

void
ipr::Visitor::visit(const C_linkage& l)
{
   visit(as<Linkage>(l));
}
